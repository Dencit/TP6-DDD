...
class SampleTest extends BaseApiTest{
    ...
    protected function setUp():void{
        ...
        //$this->userToken = $this->getUserToken()['data']['auth']['token'];
        //$this->adminToken = $this->getAdminToken()['data']['auth']['token'];
    ...
    public function testSampleUrlCreate(){
        ...
        //$result = $this->httpRequest('post',$url,$data,$header,$response); //网络请求
    ...
    public function testSampleUrlDelete($data){
        ...
        //$result = $this->httpRequest('delete',$url,$data,$header,$response);//网络请求
