...
~~~
        ...
        $schema->table($table)->setting(['number_of_shards' => 5])
            ->addColumn('id', ['type' => 'long', 'index' => 'true'])//精确索引
            ->addColumn('name', ['type' => 'text', 'index' => 'true'])//精确索引
            ->addColumn('nick_name', ['type' => 'text', 'analyzer' => 'ik_smart', 'store' => 'true']) //ik分词索引
            ->addColumn('mobile', ['type' => 'integer'])
            ->addColumn('photo', ['type' => 'text'])
            ->addColumn('sex', ['type' => 'integer'])
            ->addColumn('type', ['type' => 'integer'])
            ->addColumn('status', ['type' => 'integer'])
            ->addColumn('create_time', ['type' => 'date'])
            ->addColumn('update_time', ['type' => 'date']);
