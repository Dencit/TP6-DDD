...
class ApiToDoc{
    ...
    public function __construct($moduleName,$childName,$action='request',$dbOptStr='mysql',$testPath=null){
        //设置数据库配置
        $this->dbOption = $this->changeDbOption();
        //#
    ...
    public function changeDbOption($dbOptStr='mysql'){
        //设置数据库配置
        $optStr= 'database.connections.'.$dbOptStr;
        $dbOption = config($optStr);
